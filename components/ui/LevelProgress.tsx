  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2">
         <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#F5C76B] to-amber-600 flex items-center justify-center text-black font-bold text-sm shadow-lg">
          {level}
        </div>
        <div className="flex-1 h-2 bg-white/10 rounded-full overflow-hidden">
          <motion.div 
             className="h-full bg-gradient-to-r from-[#F5C76B] to-amber-500"
            initial={{ width: 0 }}
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="relative">
             <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#F5C76B] to-amber-600 flex items-center justify-center shadow-lg shadow-[#F5C76B]/20">
        ...
        <div className="text-right">
           <div className="text-2xl font-bold text-[#F5C76B]">{percentToNext}%</div>
      ...
      <div className="relative">
        <div className="h-4 bg-white/10 rounded-full overflow-hidden">
          <motion.div 
             className="h-full bg-gradient-to-r from-[#F5C76B] via-amber-500 to-orange-500"
            initial={{ width: 0 }}
            animate={{ width: `${percentToNext}%` }}
