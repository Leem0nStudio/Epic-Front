...
export function GachaView({ profile, onNavigate }: GachaViewProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-[#0B1A2A] bg-cover bg-center bg-no-repeat p-4 overflow-hidden relative" style={{ backgroundImage: "url('/assets/backgrounds/gachaBG.PNG')" }}>
