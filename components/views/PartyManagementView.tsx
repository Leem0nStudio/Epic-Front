    ...
    <div className="flex flex-col h-full bg-[#0B1A2A] bg-cover bg-center bg-no-repeat p-4 overflow-hidden relative" style={{ backgroundImage: `url('${AssetService.getBgUrl('party')}')` }}>
      ...
      <div className="flex items-center gap-4 mb-6 z-10 shrink-0">
       ...
       <NineSlicePanel
           type="border"
           variant="default"
           className="p-6 shadow-2xl mb-6 relative z-10 shrink-0"
           glassmorphism={true}
         >
                 ...
                 {saveData.roster
                  ...
                  .map((unit: any) => (
                   <NineSlicePanel
                    ...
                    type="border"
                    variant="default"
                    className="p-3 flex items-center gap-4 hover:opacity-90 cursor-pointer transition-all relative"
                    glassmorphism={true}
                   ...
                   >
                      ...
                      <div className="flex-1 flex flex-col min-w-0">
                        <span className="font-black text-white uppercase text-sm tracking-wider truncate">{unit.name}</span>
              ...
              <div className="flex-1 overflow-y-auto pr-1 space-y-2 custom-scrollbar">
                  {saveData.roster.map((unit: any) => (
                      <NineSlicePanel
                        ...
                        type="border"
                        variant="default"
                        className="p-3 flex items-center gap-4 hover:opacity-90 cursor-pointer group relative"
                        glassmorphism={true}
                      ...
                      >
                          ...
                          <div className="flex-1 flex flex-col min-w-0">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-[8px] font-black text-[#F5C76B] bg-[#F5C76B]/10 px-1.5 py-0.5 rounded-sm border border-[#F5C76B]/20 uppercase shrink-0">C</span>
                            </div>
