...
import { Sword, Sparkles, Shield, Store, TowerControl, Mail, Map } from 'lucide-react';

export function HomeHubView({ onNavigate }: { onNavigate: (view: any) => void }) {
  return (
    <div className="w-full flex-1 flex flex-col gap-3 relative font-sans animate-in fade-in duration-300">
      
      {/* Player Card Banner */}
      <div className="relative w-full h-[80px] bg-gradient-to-r from-[#2c1d11] via-[#4a2e1a] to-[#2c1d11] border-[2px] border-[#c79a5d] rounded-[4px] shadow-[0_4px_10px_rgba(0,0,0,0.8)] flex flex-col justify-center px-3 overflow-hidden">
        ...
        <div className="flex items-center gap-3 z-10">
           <div className="w-12 h-12 bg-[#1a110a] border-[2px] border-[#eacf9b] rounded-full overflow-hidden flex items-center justify-center shadow-inner">
           ...
           <div className="flex flex-col flex-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                 <span className="bg-[#1a110a] border border-[#a68a68] text-[#eacf9b] text-[10px] font-bold px-1.5 py-[1px] rounded-sm">LV. 12</span>
                 <div className="flex-1 h-[8px] bg-black border border-[#382618] rounded-full overflow-hidden relative">
                    <div className="h-full bg-gradient-to-r from-[#44aaff] to-[#0055ff] w-[65%]"></div>
                 </div>
      ...
      <div className="w-full aspect-[4/3] relative rounded-[4px] border-[2px] border-[#5a4227] shadow-[inset_0_4px_10px_rgba(0,0,0,0.8)] overflow-hidden bg-[#1a110a]">
         ...
         <div className="absolute bottom-2 left-2 right-2 flex gap-2">
            ...
            <button onClick={() => onNavigate('summon')} className="flex-1 bg-gradient-to-b from-[#b59d22] to-[#6e580a] border-[1.5px] border-[#ead15d] rounded p-2 flex flex-col items-center justify-center gap-1 shadow-lg active:scale-95 transition-all hover:brightness-110">
               <Sparkles size={24} className="text-white drop-shadow-md" />
               <span className="text-[12px] font-bold font-serif text-white tracking-widest text-stroke-sm">SUMMON</span>
            </button>
         </div>
      </div>

      {/* Facilities Grid */}
      <div className="grid grid-cols-2 gap-2 flex-1 relative z-10 w-full mb-2">
         
         <button onClick={() => onNavigate('unitList')} className="bg-gradient-to-br from-[#35251a] to-[#1a110a] border-[1.5px] border-[#5a4227] rounded shadow-[0_4px_6px_rgba(0,0,0,0.5)] p-2 flex flex-col items-center justify-center gap-2 group active:scale-95 transition-all hover:border-[#c79a5d] relative overflow-hidden">
            ...
            <span className="font-serif font-bold text-[#eacf9b] text-[13px] tracking-widest text-stroke-black">UNITS</span>
         </button>

         <button className="bg-gradient-to-br from-[#35251a] to-[#1a110a] border-[1.5px] border-[#5a4227] rounded shadow-[0_4px_6px_rgba(0,0,0,0.5)] p-2 flex flex-col items-center justify-center gap-2 group active:scale-95 transition-all hover:border-[#c79a5d] relative overflow-hidden">
            <div className="absolute top-0 right-0 w-16 h-16 bg-white opacity-5 rounded-full blur-xl group-hover:opacity-10 transition-opacity"></div>
            <Store size={28} className="text-[#a68a68] group-hover:text-[#c79a5d] transition-colors drop-shadow-md" />
            <span className="font-serif font-bold text-[#eacf9b] text-[13px] tracking-widest text-stroke-black">SHOP</span>
            <div className="absolute inset-0 bg-black/60 flex items-center justify-center z-10">
               <span className="bg-[#b53c22] text-white text-[9px] font-bold px-2 py-0.5 rounded border border-[#ea7a5d] shadow-sm transform -rotate-12">LOCKED</span>
            </div>
         </button>
