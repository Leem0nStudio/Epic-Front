...
'[{"id": "slime_green", "name": "Slime Verde", "level": 1, "position": 1}]'::jsonb,
...
'[{"id": "bat_red", "name": "Murciélago Rojo", "level": 2, "position": 1}]'::jsonb,
...
'[{"id": "wolf_alpha", "name": "Lobo Alfa", "level": 3, "position": 1}]'::jsonb,
...
'[{"id": "goblin", "name": "Goblin", "level": 4, "position": 1}]'::jsonb,
...
'[{"id": "skeleton", "name": "Esqueleto", "level": 5, "position": 1}]'::jsonb,
...
'[{"id": "dark_mage", "name": "Mago Oscuro", "level": 6, "position": 1}]'::jsonb,
...
'[{"id": "orc", "name": "Orco", "level": 7, "position": 1}]'::jsonb,
...
'[{"id": "golem_stone", "name": "Golem de Piedra", "level": 8, "position": 1}]'::jsonb,
...
'[{"id": "titan", "name": "Titán", "level": 10, "position": 1}]'::jsonb,
