...
INSERT INTO job_skill_modules (job_id, skill_module_id, slot_index) VALUES
    ...
    ('acolyte', (SELECT id FROM skill_modules WHERE name = 'Healing Light'), 0),
    ('acolyte', (SELECT id FROM skill_modules WHERE name = 'Holy Smite'), 1),
    ('priest', (SELECT id FROM skill_modules WHERE name = 'Healing Light'), 0),
    ('priest', (SELECT id FROM skill_modules WHERE name = 'Berserk'), 1),
    ('arch_bishop', (SELECT id FROM skill_modules WHERE name = 'Holy Smite'), 0),
    ('arch_bishop', (SELECT id FROM skill_modules WHERE name = 'Chain Lightning'), 1),
    ('paladin', (SELECT id FROM skill_modules WHERE name = 'Shield Bash'), 0),
    ('paladin', (SELECT id FROM skill_modules WHERE name = 'Holy Smite'), 1),
    ('crusader', (SELECT id FROM skill_modules WHERE name = 'Shield Bash'), 0),
    ('crusader', (SELECT id FROM skill_modules WHERE name = 'Berserk'), 1),
    ('sage', (SELECT id FROM skill_modules WHERE name = 'Fire Strike'), 0),
    ('sage', (SELECT id FROM skill_modules WHERE name = 'Vampire Bite'), 1),
    ('archmage', (SELECT id FROM skill_modules WHERE name = 'Chain Lightning'), 0),
    ('archmage', (SELECT id FROM skill_modules WHERE name = 'Focus Shot'), 1),
    ('arch_paladin', (SELECT id FROM skill_modules WHERE name = 'Holy Smite'), 0),
    ('arch_paladin', (SELECT id FROM skill_modules WHERE name = 'Shield Bash'), 1),
    ('grand_archmage', (SELECT id FROM skill_modules WHERE name = 'Thunder'), 0),
