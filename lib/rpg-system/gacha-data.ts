...
export const GACHA_DATABASE: Record<string, AnyGachaItem> = {
    ...
    'card_ghost': {
        id: 'card_ghost', name: 'Ghostring Card', type: 'card', rarity: 'epic',
    ...
    'card_baphomet': {
        id: 'card_baphomet', name: 'Baphomet Card', type: 'card', rarity: 'legendary',
    ...
    'card_hydra': {
        id: 'card_hydra', name: 'Hydra Card', type: 'card', rarity: 'epic',
    ...
    'card_valkyrie': {
        id: 'card_valkyrie', name: 'Valkyrie Randgris Card', type: 'card', rarity: 'legendary',
    ...
    // ============================================
    'wpn_blade': {
        id: 'wpn_blade', name: 'Iron Blade', type: 'weapon', rarity: 'common',
        description: 'A standard iron sword.', weaponCategory: 'sword',
        statBonuses: { atk: 50, def: 5 }
    },
    'wpn_wand': {
        id: 'wpn_wand', name: 'Apprentice Wand', type: 'weapon', rarity: 'common',
        description: 'A magical wooden catalyst.', weaponCategory: 'staff',
        statBonuses: { matk: 60, mdef: 10 }
    },
    'wpn_crimson_bow': {
        id: 'wpn_crimson_bow', name: 'Crimson Bow', type: 'weapon', rarity: 'rare',
    ...
    'wpn_murasame': {
        id: 'wpn_murasame', name: 'Murasame', type: 'weapon', rarity: 'epic',
    ...
    'wpn_staff_of_destruction': {
        id: 'wpn_staff_of_destruction', name: 'Staff of Destruction', type: 'weapon', rarity: 'legendary',
    ...
    'skill_energy_coat': {
        id: 'skill_energy_coat', name: 'Energy Coat', type: 'skill', rarity: 'epic',
    ...
    'skill_cross_impact': {
        id: 'skill_cross_impact', name: 'Cross Impact', type: 'skill', rarity: 'legendary',
    ...
    // ============================================
    'core_dark_knight': {
        id: 'core_dark_knight', name: 'Heart of the Abyss', type: 'job_core', rarity: 'legendary',
